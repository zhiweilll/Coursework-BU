...
p6=ggplot(data = plot_st_MW) +
    ...
    ggtitle(expression(paste("Joy and Sadness Sentiment")),expression(paste(italic("Marianne and Willoughby"))))+
...
p7=ggplot(data = plot_st_MW) +
    ...
    ggtitle(expression(paste("Anticipation and Anger Sentiment")),expression(paste(italic("Marianne and Willoughby"))))+
...
p8=ggplot(data = plot_st_MW) +
   ...
   ggtitle(expression(paste("Trust and Disgust Sentiment")),expression(paste(italic("Marianne and Willoughby"))))+
    theme_pander()+
    scale_fill_pander()
